...
class RecommandedProductConroller extends GetxController{
  final RecommandedProductRepo recommandedProductRepo;
  RecommandedProductConroller({required this.recommandedProductRepo});
  ...
  int checkQuantity(int quantity){
    if(_inCartItems+quantity < 0){
      ...
      Get.snackbar("Item Count", "You can't increas more than 20",
      backgroundColor: AppColors.mainColor,
      colorText: Colors.white,
      );
      return 20;
